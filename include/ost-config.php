...
define('SECRET_SALT','rVEvkTr30UOLeQfRdPBaAdqfseGQkIEJ');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','alanosmarviraspam@gmail.com');
...
define('DBNAME','sasicdb');
define('DBUSER','adminTI');
define('DBPASS','coco.root.ti');

# Table prefix
define('TABLE_PREFIX','sasic_');
